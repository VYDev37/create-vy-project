...
description: "Expert in building modular, accessible, high-performance user interfaces in React, Next.js, and TypeScript."
...
| **Colocated Client** | Hooks, state orchestration, layout wiring | Yes (`useState`, stores) | `DashboardClient.tsx` |
| **Presentational** | Visual rendering, styling | Props only | `BrandLogo.tsx`, `CurrencySection.tsx` |
