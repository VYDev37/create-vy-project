...
description: "React and Next.js state management patterns including Zustand stores, React Hook Form with Zod, Server Components, and atomic selectors."
...
- ❌ **No Duplicated Server State**: Do not copy server database queries into Zustand if Server Components can provide them directly.
