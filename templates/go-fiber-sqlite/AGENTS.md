...
This backend stack is built with **Go (Golang) 1.23+**, **Fiber v3**, **GORM SQLite (`glebarez/sqlite`)**, and **JWT + Argon2id**. Each directory has strictly isolated architectural responsibilities:
