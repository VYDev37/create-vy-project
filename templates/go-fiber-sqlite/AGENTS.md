...
- **GORM Patterns & Migrations:** Read `.agents/skills/backend/gorm-patterns.md` for models and SQLite database operations.
...
- **`cmd/main.go`:** Entry point aplikasi untuk inisialisasi konfigurasi, koneksi SQLite database, setup Fiber v3, dan mounting route handlers.
